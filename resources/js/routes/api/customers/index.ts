...
* @see app/Http/Controllers/Api/CustomerController.php:26
...
* @see app/Http/Controllers/Api/CustomerController.php:47
* @route '/api/organisations/{organisation}/customers'
*/
...
/**
* @see \App\Http\Controllers\Api\CustomerController::show
* @see app/Http/Controllers/Api/CustomerController.php:76
...
/**
* @see \App\Http\Controllers\Api\CustomerController::update
* @see app/Http/Controllers/Api/CustomerController.php:97
* @route '/api/organisations/{organisation}/customers/{customer}'
*/
...
/**
* @see \App\Http\Controllers\Api\CustomerController::destroy
* @see app/Http/Controllers/Api/CustomerController.php:126
* @route '/api/organisations/{organisation}/customers/{customer}'
*/
