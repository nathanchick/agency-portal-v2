...
* @see app/Http/Controllers/Api/TicketController.php:26
...
* @see app/Http/Controllers/Api/TicketController.php:48
* @route '/api/organisations/{organisation}/tickets'
*/
...
* @see app/Http/Controllers/Api/TicketController.php:82
...
* @see app/Http/Controllers/Api/TicketController.php:104
* @route '/api/organisations/{organisation}/tickets/{ticket}'
*/
...
* @see app/Http/Controllers/Api/TicketController.php:138
* @route '/api/organisations/{organisation}/tickets/{ticket}'
*/
