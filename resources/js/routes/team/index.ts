...
* @see app/Http/Controllers/TeamController.php:99
* @route '/team/create'
*/
...
* @see app/Http/Controllers/TeamController.php:121
* @route '/team'
*/
...
* @see app/Http/Controllers/TeamController.php:220
...
* @see app/Http/Controllers/TeamController.php:267
* @route '/team/{team}'
*/
...
* @see app/Http/Controllers/TeamController.php:387
* @route '/team/{team}'
*/
...
* @see app/Http/Controllers/TeamController.php:312
...
* @see app/Http/Controllers/TeamController.php:456
...
const team = {
    ...
    resendInvite: Object.assign(resendInvite, resendInvite),
}
