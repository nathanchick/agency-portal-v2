...
*/
export const updatePriority = (args: { automationRule: string | { id: string } } | [automationRule: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
...
* @route '/tickets/automation-rules/{automationRule}/priority'
*/
updatePriority.url = (args: { automationRule: string | { id: string } } | [automationRule: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { automationRule: args }
    }
...
* @route '/tickets/automation-rules/{automationRule}/priority'
*/
updatePriority.patch = (args: { automationRule: string | { id: string } } | [automationRule: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: updatePriority.url(args, options),
    method: 'patch',
})
