...
/**
* @see \App\Http\Controllers\OrganisationController::switchMethod
* @see app/Http/Controllers/OrganisationController.php:13
...
const OrganisationController = { switchMethod, switch: switchMethod }
