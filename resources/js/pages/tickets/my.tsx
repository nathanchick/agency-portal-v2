...
export default function MyTickets({tickets, categories, statuses, filters, sort}: Props) {
    ...
    const handleFilter = () => {
        router.get(route('customer.tickets.view'), {
            ...filterValues,
            sort_by: sortBy,
        ...
        <SidebarProvider>
            ...
            <SidebarInset>
                <AppSidebarHeader breadcrumbs={[
                    ...
                    { title: 'My Tickets', href: route('customer.tickets.view') }
                ]} />
