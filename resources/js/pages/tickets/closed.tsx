...
export default function ClosedTickets({tickets, categories, statuses, filters, sort}: Props) {
    ...
    const handleFilter = () => {
        router.get(route('customer.tickets.view.closed'), {
            ...filterValues,
            sort_by: sortBy,
        ...
        <SidebarProvider>
            ...
            <SidebarInset>
                <AppSidebarHeader breadcrumbs={[
                    ...
                    { title: 'Closed Tickets', href: route('customer.tickets.view.closed') }
                ]} />
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                View your closed support tickets
                            </p>
                        </div>
