...
export default function CreateAutomationRule({trigger, categories, labels, statuses, forms, users, customers}: Props) {
    const {data, setData, post, processing, errors} = useForm({
        ...
        is_active: true,
        trigger: trigger,
        condition_match: 'all' as 'all' | 'any',
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        post(route('tickets.automation-rules.store'));
    };
            ...
            <SidebarInset>
                    ...
                    <div className="flex items-center gap-2 px-4">
                        ...
                        <Breadcrumb>
                            <BreadcrumbList>
                                ...
                                <BreadcrumbSeparator className="hidden md:block"/>
                                <BreadcrumbItem>
                                    <BreadcrumbLink href={route('tickets.automation-rules.index')}>
                                        Automation Rules
                                    </BreadcrumbLink>
                                </BreadcrumbItem>
                                <BreadcrumbSeparator className="hidden md:block"/>
                ...
                <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
                    <div className="space-y-6">
                        <div>
                            <h2 className="text-3xl font-bold tracking-tight">Create Automation Rule</h2>
                            <p className="text-muted-foreground">
                                Set up automated workflows to streamline ticket management
                            </p>
                        </div>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            This rule will run when {data.trigger === 'ticket_created' ? 'a ticket is created' : 'a ticket is updated'}
                                        </p>
                                        {errors.trigger && (
