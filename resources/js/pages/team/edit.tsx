...
export default function EditTeamMember({ teamMember, roles, userType }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault()
        put(route('team.update', teamMember.id))
    }
        ...
        <SidebarProvider>
            ...
            <SidebarInset>
                <AppSidebarHeader breadcrumbs={[
                    ...
                    { title: 'Edit Team Member', href: route('team.edit', teamMember.id) }
                ]} />
