...
export default function CompletedDocuments({documentRequests, documents, customers, filters}: Props) {
    ...
    const handleFilter = () => {
        router.get(route('documents.completed'), filterValues, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    const handleClearFilters = () => {
        setFilterValues({});
        router.get(route('documents.completed'), {}, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    const handleEdit = (id: string) => {
        router.get(route('customer.documents.view-sign', id));
    };
        ...
        <SidebarProvider>
            ...
            <SidebarInset>
                    ...
                    <div className="flex items-center gap-2 px-4">
                        ...
                        <Breadcrumb>
                            <BreadcrumbList>
                                ...
                                <BreadcrumbItem>
                                    <BreadcrumbPage>Documents - Completed</BreadcrumbPage>
                                </BreadcrumbItem>
                            </BreadcrumbList>
                        </Breadcrumb>
                    </div>
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight">Completed Documents</h2>
                        <p className="text-muted-foreground">
                            View completed and voided document requests
                        </p>
                    </div>
                ...
                <div className="rounded-lg border bg-card p-4 overflow-visible">
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5 overflow-visible">
                        ...
                        <div className="space-y-2" ref={dateFromRef}>
                            <Label htmlFor="date_from">Signed From</Label>
                        ...
                        <div className="space-y-2" ref={dateToRef}>
                            <Label htmlFor="date_to">Signed To</Label>
                            <div className="relative">
                                <Button
                                    id="date_to"
                                    variant="outline"
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead>Signed/Voided</TableHead>
