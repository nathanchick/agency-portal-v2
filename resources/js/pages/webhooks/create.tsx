...
export default function CreateWebhook({availableModels, availableEvents}: Props) {
        ...
        <SidebarProvider>
            ...
            <SidebarInset>
                ...
                <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
                    <div>
                        <h2 className="text-3xl font-bold tracking-tight">Create Webhook</h2>
                        <p className="text-muted-foreground">
                            Configure a new webhook for your organisation
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Set up the webhook details and event triggers
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        A secret will be automatically generated if left empty
                                    </p>
                                    {errors.secret && (
