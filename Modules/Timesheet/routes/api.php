...
// Extension API endpoints (requires organisation context)
Route::middleware(['extension.token.org', 'throttle:60,1'])->prefix('extension')->name('extension.')->group(function () {
