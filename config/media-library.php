...
return [
     ...
     *
     * IMPORTANT: Using 'local' for PRIVATE storage (files not publicly accessible)
     * Files stored with 'local' disk require authentication through controller to download
     */
     ...
     * Using custom model to add human_readable_size accessor
     */
